...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 25 mai 2019 à 15:12
...
INSERT INTO `recette` (`id_recette`, `titre`, `votes_positifs`, `votes_negatifs`, `ingredients`, `description`, `image`, `date`, `FK_id_user`) VALUES
...
INSERT INTO `utilisateur` (`id_user`, `name`, `email`, `password`, `droits`) VALUES
(1, 'test', 'test@test.test', 'a94a8fe5ccb19ba61c4c0873d391e987982fbbd3', 'user'),
(3, 'visiteur', 'visiteur@ici.ici', '922391a72f5d8792a0b66b6cb3674d5eae454bda', 'visiteur'),
(4, 'admin', 'admin@ici.ici', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin'),
(5, 'liloo', 'liloo@multipass.test', '6b2cb6f64f56257b8e4fe12a06087fee831481da', 'user'),
(6, 'pino', 'semmoud29@gmail.com', '3d95672b7ca966952d7ce9f5dd20f5585f66f52e', 'user'),
(7, 'Marine', 'marine@test.test', '1fd1b4516473c36c8fb30bbf7c4490fc20419a10', 'user'),
(8, 'Marinea', 'marinea@test.test', '1fd1b4516473c36c8fb30bbf7c4490fc20419a10', 'visiteur'),
(9, 'MarineB', 'marineB@test.test', '1fd1b4516473c36c8fb30bbf7c4490fc20419a10', 'visiteur'),
(10, 'Julien', 'julien@test.test', '5c682c2d1ec4073e277f9ba9f4bdf07e5794dabe', 'visiteur');

-- --------------------------------------------------------

--
-- Structure de la table `vote_recette`
--

CREATE TABLE `vote_recette` (
  `FK_id_recette` int(5) NOT NULL,
  `FK_id_user` int(5) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `vote_recette`
--

INSERT INTO `vote_recette` (`FK_id_recette`, `FK_id_user`) VALUES
(11, 1),
(11, 3);
...
ALTER TABLE `commentaire`
  ...
  ADD KEY `FK_id_recette` (`FK_id_recette`),
...
--
-- Index pour la table `vote_recette`
--
ALTER TABLE `vote_recette`
  ADD PRIMARY KEY (`FK_id_recette`,`FK_id_user`),
  ADD KEY `FK_id_user` (`FK_id_user`);
...
--
ALTER TABLE `recette`
  MODIFY `id_recette` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `commentaire`
  ADD CONSTRAINT `commentaire_ibfk_1` FOREIGN KEY (`FK_id_recette`) REFERENCES `recette` (`id_recette`),
  ADD CONSTRAINT `commentaire_ibfk_2` FOREIGN KEY (`FK_id_user`) REFERENCES `utilisateur` (`id_user`);

--
-- Contraintes pour la table `recette`
--
ALTER TABLE `recette`
  ADD CONSTRAINT `recette_ibfk_1` FOREIGN KEY (`FK_id_user`) REFERENCES `utilisateur` (`id_user`);

--
-- Contraintes pour la table `vote_recette`
--
ALTER TABLE `vote_recette`
  ADD CONSTRAINT `vote_recette_ibfk_1` FOREIGN KEY (`FK_id_recette`) REFERENCES `recette` (`id_recette`),
  ADD CONSTRAINT `vote_recette_ibfk_2` FOREIGN KEY (`FK_id_user`) REFERENCES `utilisateur` (`id_user`);
COMMIT;
